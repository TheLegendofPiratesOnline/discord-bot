...
class BotCore(Commands.Commands):
    ...
    def __init__(self):
        ...
        BotLocalizer.importLanguageModule(language, self.settings.getSetting('autoTranslate'), self.settings.getSetting('debug'))
        ...
        # Initialize taskMgr.
        self.taskMgr = BotTasks.BotTasks(self.settings.getSetting('maxNewsAricles'), self.settings.getSetting('debug'))
